  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        <div className='text-center'>
            ...
            <p className='text-gray-500 max-w-lg mx-auto'>Eveything you need to create,enhance,and optimize your content with cutting-edge AI technology.</p>
        </div>
      
     <div className='flex flex-wrap mt-10 justify-center'>
{AiToolsData.map((tool,index)=>(
    <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition-all
