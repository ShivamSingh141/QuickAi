...
formdata.append('object', object); 
  ...
  <form onSubmit={onsubmithandler}className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
      ...
      <div className='flex items-center gap-3' >
        ...
        <h1 className='text-xl font-semibold'>Object Removal Removal</h1>
      </div>

      <p className='mt-6 text-sm font-medium'>Upload image</p>

      <input onChange={(e)=>setinput(e.target.files[0])} 
      type="file" accept='image/*' className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md 
...
bg-gradient-to-r from-[#417DF6] to-[#8E37EB] text-white px-4 py-4  mt-6
