...
formdata.append('resume',input);
  ...
  <form onSubmit={onsubmithandler}className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
      ...
      type="file" accept='application/pdf' className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md 
...
bg-gradient-to-r from-[#00DA83] to-[#009BB3] text-white px-4 py-4 py-2 mt-6
